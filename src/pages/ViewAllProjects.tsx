...
const ViewAllProjects = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        "Modern weather application with detailed forecasts, interactive maps, and location-based alerts.",
      image:
        ...
        <div className="section-container py-8">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-foreground-muted max-w-2xl mx-auto">
              Explore my complete portfolio of web applications, showcasing
